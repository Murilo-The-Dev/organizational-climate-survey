...
func SetupRouter(config *RouterConfig) *mux.Router {
	...
	// Registrar rotas dos handlers nas rotas autenticadas
	...
	if respostaHandler != nil {
		...
		// Usar método RegisterRoutes do handler em vez de definir rotas manualmente
		// Mas excluir a rota de submissão pública
	...
	// Rota de documentação da API (se usando Swagger)
...
func HealthCheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Usar time.Now() em vez de header que pode estar vazio
...
func SetupMinimalRouter(config *RouterConfig) *mux.Router {
	...
	// Rotas de autenticação se disponíveis
