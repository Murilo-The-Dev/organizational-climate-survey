// Package postgres implementa o repositório de Pergunta usando PostgreSQL.
// Fornece operações CRUD e consultas específicas para gerenciamento de perguntas de pesquisa.
package postgres
...
// PerguntaRepository implementa a interface repository.PerguntaRepository
...
// NewPerguntaRepository cria uma nova instância do repositório
...
// Garante que PerguntaRepository implementa a interface correta
var _ repository.PerguntaRepository = (*PerguntaRepository)(nil)

// Create insere uma nova pergunta no banco de dados
...
// CreateBatch insere múltiplas perguntas em uma única transação
...
// GetByPesquisaID busca todas as perguntas de uma pesquisa específica
// Ordenadas por ordem de exibição
...
// Utiliza internamente GetByPesquisaID para manter consistência
...
// Update atualiza os dados de uma pergunta existente
...
// Delete remove uma pergunta do banco de dados
