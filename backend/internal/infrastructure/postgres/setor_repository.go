// Package postgres implementa o repositório de Setor usando PostgreSQL.
// Fornece operações CRUD e consultas específicas para gerenciamento de setores empresariais.
package postgres
...
// SetorRepository implementa a interface repository.SetorRepository
type SetorRepository struct {
	db     *DB           // Conexão com o banco de dados
	logger logger.Logger // Logger para operações do repositório
}

// NewSetorRepository cria uma nova instância do repositório
...
// Garante que SetorRepository implementa a interface correta
var _ repository.SetorRepository = (*SetorRepository)(nil)

// Create insere um novo setor no banco de dados
...
// GetByNome busca um setor pelo nome dentro de uma empresa específica
// Retorna erro específico quando não encontrado
...
// Retorna erro se o setor não for encontrado
...
// Delete remove um setor do banco de dados
