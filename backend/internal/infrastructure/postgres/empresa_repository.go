// Package postgres implementa o repositório de Empresa usando PostgreSQL.
// Fornece operações CRUD e consultas específicas para gerenciamento de empresas.
package postgres
...
// EmpresaRepository implementa a interface repository.EmpresaRepository
type EmpresaRepository struct {
	db     *DB           // Conexão com o banco de dados
	logger logger.Logger // Logger para operações do repositório
}

// NewEmpresaRepository cria uma nova instância do repositório
...
// Garante que EmpresaRepository implementa a interface correta
...
// List lista todas as empresas com paginação
...
// Update atualiza os dados de uma empresa existente
// Retorna erro se a empresa não for encontrada
...
// Delete remove uma empresa do banco de dados
