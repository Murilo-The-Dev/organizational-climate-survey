...
// @Description Cria empresa e primeiro administrador. Endpoint de bootstrap para configuração inicial.
// @Tags bootstrap
// @Accept json
// @Produce json
// @Param body body dto.BootstrapRequest true "Dados de bootstrap"
